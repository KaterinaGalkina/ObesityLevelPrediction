...
#-----------------------------------------------------------------------
# The best number of clusters according to wssplot() & 70-30% data division 
#-----------------------------------------------------------------------
...
#-----------------------------------------------------------------------
# Trying different combinations suggested in the instructions 
#-----------------------------------------------------------------------

#-----------------------------------------------------------------------
#   First prediction using Weight, family_history_with_overweight and Age as explanatory attributes 
#   Training and Testing sets division : 70-30%
#   Number of clusters used : 5, 7, 9, 11
#-----------------------------------------------------------------------

#-----------------------------------------------------------------------
# Number of clusters = 5 and the following explanatory attributes : Weight, family_history_with_overweight, Age

subset_data.train1.glm = glm(NObeyesdad ~ Weight + family_history_with_overweight + Age, 
                             family = gaussian, data = subset_data.train1)

subset_data.test1.pred = predict(subset_data.train1.glm, newdata = subset_data.test1)

subset_data.test1.pred.k5 = kmeans(subset_data.test1.pred, centers = 5)
subset_data.test1.kmeans.k5 = kmeans(subset_data.test1, centers = 5)

# Cross tabulation 
subset_data.test1.ct.k5 = CrossTable(subset_data.test1.pred.k5$cluster, 
                                     subset_data.test1.kmeans.k5$cluster, 
                                     prop.chisq = TRUE)

confusion_matrix <- subset_data.test1.ct.k5$t

# Different measurements
print_measurements(confusion_matrix)

#-----------------------------------------------------------------------
# Number of clusters = 7 and the following explanatory attributes : Weight, family_history_with_overweight, Age
...
subset_data.test1.pred.k7 = kmeans(subset_data.test1.pred, centers = 7)
subset_data.test1.kmeans.k7 = kmeans(subset_data.test1, centers = 7)

# Cross tabulation 
subset_data.test1.ct.k7 = CrossTable(subset_data.test1.pred.k7$cluster, 
                                     subset_data.test1.kmeans.k7$cluster, 
                                     prop.chisq = TRUE)

confusion_matrix <- subset_data.test1.ct.k7$t

# Different measurements
print_measurements(confusion_matrix)

#-----------------------------------------------------------------------
# Number of clusters = 9 and the following explanatory attributes : Weight, family_history_with_overweight, Age
...
subset_data.test1.pred.k9 = kmeans(subset_data.test1.pred, centers = 9)
subset_data.test1.kmeans.k9 = kmeans(subset_data.test1, centers = 9)

# Cross tabulation 
subset_data.test1.ct.k9 = CrossTable(subset_data.test1.pred.k9$cluster, 
                                     subset_data.test1.kmeans.k9$cluster, 
                                     prop.chisq = TRUE)

confusion_matrix <- subset_data.test1.ct.k9$t

# Different measurements
print_measurements(confusion_matrix)

#-----------------------------------------------------------------------
# Number of clusters = 11 and the following explanatory attributes : Weight, family_history_with_overweight, Age
...
subset_data.test1.pred.k11 = kmeans(subset_data.test1.pred, centers = 11)
subset_data.test1.kmeans.k11 = kmeans(subset_data.test1, centers = 11)

# Cross tabulation 
subset_data.test1.ct.k11 = CrossTable(subset_data.test1.pred.k11$cluster, 
                                      subset_data.test1.kmeans.k11$cluster, 
                                      prop.chisq = TRUE)

confusion_matrix <- subset_data.test1.ct.k11$t

# Different measurements
print_measurements(confusion_matrix)

# We can clearly see that more number of clusters is biggest, less True positive 
# values we have for each cluster, which is understandable as the probability 
# of picking the right cluster is fewer

# Let us now try the best number of clusters which is 5, but with 
# fewer explanatory attributes and another division proportions into 
# Training and Testing sets

#-----------------------------------------------------------------------
#   Second predictions using Weight and family_history_with_overweight as explanatory attributes 
#   Training and Testing sets division : 60-40% number of clusters 
#   Number of clusters : 5 
#-----------------------------------------------------------------------

#-----------------------------------------------------------------------
# Number of clusters = 5 and the following explanatory attributes : Weight, family_history_with_overweight

subset_data.train2.glm = glm(NObeyesdad ~ Weight + family_history_with_overweight, 
                             family = gaussian, data = subset_data.train2)

subset_data.test2.pred = predict(subset_data.train2.glm, newdata = subset_data.test2)

subset_data.test2.pred.k5 = kmeans(subset_data.test2.pred, centers = 5)
subset_data.test2.kmeans.k5 = kmeans(subset_data.test2, centers = 5)

# Cross tabulation 
subset_data.test2.ct.k5 = CrossTable(subset_data.test2.pred.k5$cluster, 
                                     subset_data.test2.kmeans.k5$cluster, 
                                     prop.chisq = TRUE)

confusion_matrix <- subset_data.test2.ct.k5$t

# Different measurements
print_measurements(confusion_matrix)

#-----------------------------------------------------------------------
#   Third predictions using Weight and family_history_with_overweight as explanatory attributes 
#   Training and Testing sets division : 50-50% number of clusters 
#   Number of clusters : 5 
#-----------------------------------------------------------------------
...
subset_data.train3.glm = glm(NObeyesdad ~ Weight + family_history_with_overweight, 
                             family = gaussian, data = subset_data.train3)

subset_data.test3.pred = predict(subset_data.train3.glm, newdata = subset_data.test3)

subset_data.test3.pred.k5 = kmeans(subset_data.test3.pred, centers = 5)
subset_data.test3.kmeans.k5 = kmeans(subset_data.test3, centers = 5)

# Cross tabulation 
subset_data.test3.ct.k5 = CrossTable(subset_data.test3.pred.k5$cluster, 
                                     subset_data.test3.kmeans.k5$cluster, 
                                     prop.chisq = TRUE)

confusion_matrix <- subset_data.test3.ct.k5$t
